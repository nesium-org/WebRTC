Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/nesium-org/WebRTC
  spec.license      = { :type => 'BSD', :file => 'WebRTC.xcframework/LICENSE' }
  spec.author       = "Stasel"
  spec.ios.deployment_target = '12.0'
  spec.osx.deployment_target = '10.11'

  spec.source       = { :http => "https://github.com/nesium-org/WebRTC/releases/download/130.0.0/WebRTC-M130.xcframework.zip" }
